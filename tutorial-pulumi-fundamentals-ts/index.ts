...
const dbHost = `${databaseHost}:${databasePort}`
...
export const frontendContainerNameOutput = frontendContainer.name
export const backendContainerNameOutput = backendContainer.name
export const databaseContainerNameOutput = databaseContainer.name